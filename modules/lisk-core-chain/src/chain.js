...
module.exports = class Chain {
	...
	async bootstrap() {
		const loggerConfig = await this.channel.invoke('lisk:getComponentConfig', 'logger');
		this.logger = Logger(loggerConfig).child({identifier: 'chain'});

		this.channel.subscribe('chain:newTransaction', this.onNewTransaction.bind(this));
