...
[![Build Status](https://jenkins.lisk.io/buildStatus/icon?job=lisk-core2/master)](https://jenkins.lisk.io/job/lisk-core2/job/master/)
[![License: GPL v3](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](http://www.gnu.org/licenses/gpl-3.0)
<a href="https://david-dm.org/LiskHQ/lisk-core2"><img src="https://david-dm.org/LiskHQ/lisk-core2.svg" alt="Dependency Status"></a>
<a href="https://david-dm.org/LiskHQ/lisk-core2/?type=dev"><img src="https://david-dm.org/LiskHQ/lisk-core2/dev-status.svg" alt="devDependency Status"></a>
...
```sh
curl --silent --user my_github_username "https://raw.githubusercontent.com/LiskHQ/lisk-core2/master/bin/bootstrap.sh" | bash -ls my-fresh-lisk-project
```
...
1. Find and replace all instances of `lisk-core2` with your project name
...
1. Add a Coveralls configuration file at `~/.coveralls.yml-lisk-core2` on all
	Jenkins nodes that will be used to build lisk-core2.
...
https://github.com/LiskHQ/lisk-core2/graphs/contributors
...
[bootstrap-script]: https://github.com/LiskHQ/lisk-core2/blob/master/bin/bootstrap.sh
[chai]: http://chaijs.com/
[coveralls]: https://coveralls.io/
[eslint]: https://eslint.org/
[gwt-blogpost]: https://blog.lisk.io/bdd-style-unit-testing-with-mocha-704137e429d5
[husky]: https://github.com/typicode/husky
[license]: https://github.com/LiskHQ/lisk-core2/tree/master/LICENSE
