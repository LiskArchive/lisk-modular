# Contributing to lisk-core2

First off, thanks for taking the time to contribute! :raised_hands:

The following is a set of guidelines for contributing to lisk-core2, which
...
[lisk-core2 Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are
...
This section guides you through submitting a bug report for lisk-core2.
...
* **Did the problem start happening recently** (e.g. after updating to a new
	version of lisk-core2, Lisk or any other repository) or was this always a
	problem?
* If the problem started happening recently, **can you reproduce the problem in
	an older version of lisk-core2?** What’s the most recent version in which
	the problem doesn’t happen? You can download older versions of lisk-core2
	from [the releases page](https://github.com/LiskHQ/lisk-core2/releases).
...
lisk-core2, including completely new features and minor improvements to
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps
	or point out the part of lisk-core2 which the suggestion is related to. You
...
* **Explain why this enhancement would be useful** to most Lisk and
	lisk-core2 users.
* **Specify which version of Lisk and lisk-core2 you’re using.**
...
On lisk-core2 we are using [Prettier](https://prettier.io/) and
