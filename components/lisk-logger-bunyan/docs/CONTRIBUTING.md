# Contributing to lisk-logger-bunyan2

First off, thanks for taking the time to contribute! :raised_hands:

The following is a set of guidelines for contributing to lisk-logger-bunyan2, which
...
[lisk-logger-bunyan2 Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are
...
This section guides you through submitting a bug report for lisk-logger-bunyan2.
...
* **Did the problem start happening recently** (e.g. after updating to a new
	version of lisk-logger-bunyan2, Lisk or any other repository) or was this always a
	problem?
* If the problem started happening recently, **can you reproduce the problem in
	an older version of lisk-logger-bunyan2?** What’s the most recent version in which
	the problem doesn’t happen? You can download older versions of lisk-logger-bunyan2
	from [the releases page](https://github.com/LiskHQ/lisk-logger-bunyan2/releases).
...
lisk-logger-bunyan2, including completely new features and minor improvements to
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps
	or point out the part of lisk-logger-bunyan2 which the suggestion is related to. You
...
* **Explain why this enhancement would be useful** to most Lisk and
	lisk-logger-bunyan2 users.
* **Specify which version of Lisk and lisk-logger-bunyan2 you’re using.**
...
On lisk-logger-bunyan2 we are using [Prettier](https://prettier.io/) and
